---
title: 'Perhitungan Panel Lele Rp 170.000.000 per bulan'
date: '2025-04-29'
lastmod: '2025-04-29'
tags: ['next-js', 'tailwind', 'guide', 'feature']
draft: false
summary: 'Target laba bersih kamu: Rp 170.000.000 per bulan. Harga jual ikan lele: Rp 18.000 per kilogram. Asumsi tambahan: Biaya produksi pakan = Rp 0, Biaya yang perlu ditanggung hanya pegawai dan biaya lain-lain.'
...
​Jika Anda menargetkan keuntungan bersih sebesar Rp170 juta per bulan dari budidaya ikan lele, dengan asumsi:

- Harga jual lele: Rp18.000 per kilogram
- Panen setiap 3 bulan
- Setiap kolam berisi 1.000 ekor lele
- Biaya pakan diabaikan (karena diproduksi sendiri)
- Biaya operasional lainnya sekitar 40% dari omzet

Maka, perhitungan kebutuhan kolam adalah sebagai berikut:

## 1. Menentukan Omzet dan Produksi Bulanan

Untuk mencapai laba bersih Rp170 juta per bulan dengan margin keuntungan 60% (karena 40% digunakan untuk biaya operasional):​

Omzet bulanan = Rp170.000.000 / 0,6 = Rp283.333.333

Produksi lele per bulan = Rp283.333.333 / Rp18.000/kg ≈ 15.740 kg

## 2. Produksi per Siklus (3 Bulan)

Karena panen dilakukan setiap 3 bulan, maka produksi per siklus adalah:​

Produksi per siklus = 15.740 kg x 3 = 47.220 kg

## 3. Produksi per Kolam per Siklus

Dengan asumsi:​

Jumlah lele per kolam: 1.000 ekor

Tingkat kelangsungan hidup (SR): 80% → 800 ekor

Berat rata-rata saat panen: 200 gram (0,2 kg)​

Maka, produksi per kolam per siklus:​

Produksi per kolam = 800 ekor x 0,2 kg = 160 kg​

## 4. Jumlah Kolam yang Diperlukan

Untuk mencapai produksi 47.220 kg per siklus:​
YouTube

Jumlah kolam = 47.220 kg / 160 kg per kolam ≈ 295 kolam​

Jadi, Anda memerlukan sekitar 295 kolam, masing-masing berisi 1.000 ekor lele, untuk mencapai target keuntungan tersebut dengan siklus panen setiap 3 bulan.​

Perlu diingat, jumlah ini bisa bervariasi tergantung pada faktor-faktor seperti tingkat kelangsungan hidup ikan, berat rata-rata saat panen, dan efisiensi operasional.
